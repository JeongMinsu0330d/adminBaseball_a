...
public class ReservationDetail {
    ...
    public ReservationDetail(int seq, int userNo, long tradeId, String ageType, int stadiumNo, String stadiumName, int homeTeamNo, String homeTeamName, int awayTeamNo, String awayTeamName, int gameListSeq, int stadiumSeatListSeq, int seatNo, String reservationState, int objectSeq, int totalPrice, String ticketType, int ticketPrice, String discountCode, int discountPrice, int adminNo, String regDate) {
        this.seq = seq;
        this.userNo = userNo;
